<template>
  <div class="app-container">
    <el-card shadow="hover" style="text-align: center; margin: 8px; font-weight: bold">消息统计</el-card>
    <panel-group/>
    <el-row>
    ...
    <el-table
      ...
      <el-table-column align="center" type="expand">
        <template slot-scope="scope">
          <el-col :span="6">
            <el-row>
              <el-tag style="margin-bottom: 8px">用户id1</el-tag>
              <span>{{ scope.row.id1 }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">用户id2</el-tag>
              <span>{{ scope.row.id2 }}</span>
            </el-row>
          </el-col>
          <el-col :span="6">
            <el-row>
              <el-tag style="margin-bottom: 8px">用户昵称1</el-tag>
              <span>{{ scope.row.nick1 }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">用户昵称2</el-tag>
              <span>{{ scope.row.nick2 }}</span>
            </el-row>
          </el-col>
          <el-col :span="6">
            <el-row>
              <el-tag style="margin-bottom: 8px">发送者所在地</el-tag>
              <span>{{ scope.row.location }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">发送时间</el-tag>
              <span>{{ scope.row.time }}</span>
            </el-row>
          </el-col>
          <el-col :span="6">
            <el-row>
              <el-tag style="margin-bottom: 8px">发送者机型</el-tag>
              <span>{{ scope.row.model }}</span>
            </el-row>
            <el-row>
              <el-tag style="margin-bottom: 8px">消息内容</el-tag>
...
import qs from 'qs'
import PanelGroup from '../Index/components/PanelGroup'
